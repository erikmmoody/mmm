...
public class MeanMedianModeTest {
    ...
    /*
    The test files used in the following two tests, uniformDist.txt and normalDist.txt,
    were generated by python's numpy library and verified by the numpy and scipy libraries.
    */
    @Test
